...
Label(root, text="Language Translator", font="Arial 20 bold", bg='skyblue').pack()          # Label for the heading
Label(root, text="Enter Text", font='arial 13 bold', bg='skyblue').place(x=165, y=90)       # Label for the input text box

# creating the input text box
Input_text=Entry(root, width= 60) 
Input_text.place(x=30, y = 130) 
Input_text.get()
Label(root, text = "Output", font='arial 13 bold', bg='skyblue').place(x= 750, y= 90)       # Label for the input text box
